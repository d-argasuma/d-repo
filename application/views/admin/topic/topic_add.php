			...
			<div class="container-fluid">
				...
				<div class="card mb-3">
					<div class="card-header">
						<a href="<?php echo site_url('admin/topic/') ?>"><i class="fas fa-arrow-left"></i> Back</a>
					</div>
					<div class="card-body">

						<form action="<?php base_url('admin/topic/add') ?>" method="post" >
							<div class="form-group">
								<label for="topic_title">Title *</label>
								<input class="form-control <?php echo form_error('topic_title') ? 'is-invalid':'' ?>"
								 type="text" name="topic_title"  />
