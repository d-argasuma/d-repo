						...
						<form action="<?php base_url('admin/user/edit') ?>" method="post" enctype="multipart/form-data">
							...
							<div class="form-group">
								...
								<input class="form-control <?php echo form_error('password') ? 'is-invalid':'' ?>"
								 type="password" name="password" min="0"  value="<?php echo $user->password ?>" />
								<div class="invalid-feedback">
                            ...
                            <div class="form-group">
								...
								<input class="form-control <?php echo form_error('full_name') ? 'is-invalid':'' ?>"
								 type="text" name="full_name" min="0"  value="<?php echo $user->full_name ?>" />
								<div class="invalid-feedback">
                            ...
                            <div class="form-group">
								...
								<input class="form-control <?php echo form_error('email') ? 'is-invalid':'' ?>"
								 type="text" name="email" min="0"  value="<?php echo $user->email ?>" />
								<div class="invalid-feedback">
							...
							<div class="form-group">
								...
								<input type="hidden" name="old_prof_pic" value="<?php echo $user->prof_pic ?>" />
								<div class="invalid-feedback">
							...
							<div class="form-group">
								...
								<?php foreach ($roles as $role): ?>                      
									<option <?php echo $user->role_code == $role->role_code ? 'selected': '' ?> value="<?php echo $role->role_code ?>"><?php echo $role->role_name ?></option>
								<?php endforeach; ?>
								</select>
								<div class="invalid-feedback">
